# Configuration for `/var/ossec/etc/ossec.conf`
...
<ossec_config>
  <global>
    ...
    <email_from>sender@domain.com</email_from>
    <email_to>receiver@domain.com</email_to>
...
-->
  ...
  <syscheck>
    ...
    <directories>/bin,/sbin,/boot,/root,/tmp,/opt,/etc,/home</directories>
...
<!-- Cluster configuration disabled for standalone manager -->
<!-- Commented out if not running a cluster
  <cluster>
    <name>wazuh</name>
